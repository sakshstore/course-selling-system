Copilot, 12:46
Your updated code looks great! You've successfully removed the button and directly displayed the referral link. Here are
a few minor improvements to ensure everything works smoothly:

1.
API Service Integration: Let's integrate the API calls into your apiservice.js file.
2.
Component Code: Use the functions from apiservice.js in your component.

First, update your apiservice.js file:
...
Next, update your component code to use these functions:
    ...
    <div class="mt-5">
        ...
        <div>
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" :class="{ active: activeTab === 'referrals' }"
                        @click="activeTab = 'referrals'">Referral Report</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" :class="{ active: activeTab === 'transactions' }"
                        @click="activeTab = 'transactions'">Transaction History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" :class="{ active: activeTab === 'withdrawals' }"
                        @click="activeTab = 'withdrawals'">Withdrawal Report</a>
                </li>
            </ul>
            <div class="tab-content mt-3">
                ...
                <div v-if="activeTab === 'transactions'" class="tab-pane active">
                    ...
                    <p v-else>You have no data yet.</p>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            @click="showWithdrawalModal = false">Close</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    setup() {
        ...
        const fetchCurrencySymbol = async () => {
            try {
                const response = await apiService.getCurrencySymbol();
        ...
        const fetchReferralReport = async () => {
            try {
                const response = await apiService.getReferralReport();
