                ...
                <div class="modal-body">
                    <form @submit.prevent="createTicket">
                        <div class="mb-3">
                            ...
                            <input v-model="newTicket.title" type="text" class="form-control" id="title" placeholder="Enter ticket title" required />
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea v-model="newTicket.description" class="form-control" id="description" rows="3" placeholder="Enter ticket description" required></textarea>
                        </div>
                        <div class="mb-3">
