...
export default {
    setup() {
        ...
        const fetchLeads = async () => {
            try {
                const response = await apiService.getUserLeads(route.params.id);
        ...
        const fetchContacts = async () => {
            try {
                const response = await apiService.getUserContacts(route.params.id);
        ...
        const updateUser = async () => {
            try {
                await apiService.updateUser(route.params.id, user.value);
                this.$printtoast('User updated successfully!');
            } catch (error) {
